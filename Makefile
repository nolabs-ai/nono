...
.PHONY: all build build-lib build-cli build-ffi build-arm64 build-sideload test test-lib test-cli test-ffi test-spiffe check clippy fmt clean install audit help
