...
| **Composition** | `extends`, group references | Fully resolved, no composition |
...
2. **No legacy aliases** -- Clean field names only. Any future back-compat parsing belongs in the profile layer, never here.
