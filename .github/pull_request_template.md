...
If this PR is generated by an AI agent, per [AGENTS.md](AGENTS.md) you must include:
...
- [ ] All new code follows the project's coding standards ([AGENTS.md](AGENTS.md)) and is covered by tests
