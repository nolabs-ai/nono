...
---
*Last updated: 2026-05-01 after Phase 26 Plan 26-01 close. v2.3 progress: 9/14 requirements closed — REQ-AIPC-NIX-01 (Phase 25 Plan 25-02), REQ-AUDC-01..03 (Phase 28 Plan 28-01), REQ-WRU-01..02 (Phase 29 Plan 29-01), REQ-PKGS-02 + REQ-PKGS-03 (Phase 26 Plan 26-01, commits `e5e1f2d7`/`dd7b28b3`/`797f3295`/`8ff89923`/`1f47d0ee`/`464cd4d4`). Plan 26-01 used D-20 manual replay for upstream `58b5a24e` (cherry-pick would have deleted fork's `validate_path_within` defense-in-depth, a security regression); both validators preserved. `ArtifactType::Plugin` added as 7th variant. v2.3 fully PLANNED — all reqs are now scoped: Plan 25-01 (RESL Unix) + Plan 26-02 (PKGS streaming + auto-pull) + Phase 27 (AAH resumption) all queued for Linux/macOS host or post-`NONO_TEST_HOME` seam. v2.4 candidate phase: "Windows test-harness HOME redirection" — once landed, all queued work executes on Windows. Remaining v2.3: REQ-RESL-NIX-01..03 + REQ-PKGS-01 + REQ-PKGS-04 + REQ-AAH-01.*
