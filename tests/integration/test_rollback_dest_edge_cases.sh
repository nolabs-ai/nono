...
before_count=$(count_session_dirs "$default_root")
...
after_count=$(count_session_dirs "$default_root")
...
isolated_count=$(count_session_dirs "$ISOLATED_DEST")
...
multi_count=$(count_session_dirs "$MULTI_DEST")
