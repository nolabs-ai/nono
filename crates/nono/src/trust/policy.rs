...
mod tests {
    ...
    mod merge_policies {
        use super::super::*;
        use super::{keyed_publisher, keyless_publisher, make_policy};
    ...
    mod evaluate_file {
        ...
        fn evaluate_trusted_gitlab_keyless() {
            ...
            let identity = SignerIdentity::Keyless {
                ...
                workflow: "gitlab.com/my-group/my-project//.gitlab-ci.yml@refs/heads/main"
                    .to_string(),
        ...
        fn evaluate_untrusted_gitlab_wrong_project() {
            ...
            let identity = SignerIdentity::Keyless {
                ...
                workflow: "gitlab.example.com/evil/project//.gitlab-ci.yml@refs/heads/main"
                    .to_string(),
                git_ref: "refs/heads/main".to_string(),
                build_signer_uri: "*".to_string(),
            };
    ...
    mod find_included_files {
        ...
        fn find_included_files_respects_extra_skip_dirs() {
            ...
            let policy = make_policy(Enforcement::Deny, vec![], vec![]);
            let files = find_included_files_with_skip_dirs(
                &policy,
                dir.path(),
